#include "main.h"
/**
 * get_path- takes in the name of a file and returns the file path
 * @filename: name of the file we are looking to get the path
 * Return: returns the path if it exist, else it returns the filename.
*/
